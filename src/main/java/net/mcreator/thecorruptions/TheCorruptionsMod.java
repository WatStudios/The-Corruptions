package net.mcreator.thecorruptions;
...
import net.mcreator.thecorruptions.init.TheCorruptionsModTabs;
...
@Mod("the_corruptions")
public class TheCorruptionsMod {
	public static final Logger LOGGER = LogManager.getLogger(TheCorruptionsMod.class);
	public static final String MODID = "the_corruptions";

	public TheCorruptionsMod() {
		...
		TheCorruptionsModTabs.REGISTRY.register(bus);

		TheCorruptionsModMenus.REGISTRY.register(bus);
		TheCorruptionsModAttributes.REGISTRY.register(bus);
